...
{id:"netplus", name:"Network+", code:"N10-009", vendor:"CompTIA", track:"foundational", level:"Foundational", hours:"~80h", color:"#22d3ee",
 desc:"Fundamentos de redes: TCP/IP, routing, switching, wireless, troubleshooting. Pre-requisito mental para Sec+.", status:"coming"},
{id:"isc2cc", name:"Certified in Cybersecurity (CC)", code:"CC", vendor:"ISC2", track:"foundational", level:"Entry", hours:"~40h", color:"#f59e0b",
 desc:"Cert gratuita de entrada de ISC2. Cinco dominios básicos. Buen primer paso si nunca has tocado seguridad.", status:"coming"},
{id:"aplus", name:"A+", code:"220-1101/1102", vendor:"CompTIA", track:"foundational", level:"Entry", hours:"~80h", color:"#34d399",
 desc:"Hardware, SO, troubleshooting de IT general. Útil si vienes de cero absoluto.", status:"coming"},

// === BLUE TEAM / DEFENSIVE ===
{id:"cysaplus", name:"CySA+", code:"CS0-003", vendor:"CompTIA", track:"blue", level:"Intermediate", hours:"~120h", color:"#3b82f6",
 desc:"Cybersecurity Analyst. Enfoque SOC: análisis de amenazas, gestión de vulnerabilidades, IR, threat hunting. Paso natural tras Sec+.", status:"coming"},
{id:"casp", name:"SecurityX (CASP+)", code:"CAS-005", vendor:"CompTIA", track:"blue", level:"Advanced", hours:"~150h", color:"#8b5cf6",
 desc:"Antes CASP+. Nivel avanzado: arquitectura de seguridad empresarial, gobernanza, riesgo. Para arquitectos.", status:"coming"},
{id:"gcih", name:"GCIH", code:"GCIH", vendor:"GIAC/SANS", track:"blue", level:"Intermediate", hours:"~120h", color:"#ef4444",
 desc:"GIAC Certified Incident Handler. Manejo de incidentes en profundidad. Reconocida en sector financiero/gov.", status:"coming"},
{id:"gcia", name:"GCIA", code:"GCIA", vendor:"GIAC/SANS", track:"blue", level:"Intermediate", hours:"~120h", color:"#dc2626",
 desc:"GIAC Certified Intrusion Analyst. Análisis de tráfico, IDS, packet analysis con Wireshark/tcpdump.", status:"coming"},
{id:"gcfa", name:"GCFA", code:"GCFA", vendor:"GIAC/SANS", track:"blue", level:"Advanced", hours:"~150h", color:"#b91c1c",
 desc:"GIAC Certified Forensic Analyst. Forense profundo: memoria, disco, timeline analysis.", status:"coming"},
{id:"btl1", name:"Blue Team Level 1", code:"BTL1", vendor:"Security Blue Team", track:"blue", level:"Intermediate", hours:"~100h", color:"#0ea5e9",
 desc:"Práctico 100% hands-on: phishing analysis, OSINT, IR, threat intel, SIEM. Examen 24h en lab real.", status:"coming"},
{id:"sscp", name:"SSCP", code:"SSCP", vendor:"ISC2", track:"blue", level:"Intermediate", hours:"~100h", color:"#0891b2",
 desc:"Systems Security Certified Practitioner. ISC2 técnica para administradores con 1 año experiencia.", status:"coming"},

// === RED TEAM / OFFENSIVE ===
{id:"pentest", name:"PenTest+", code:"PT0-003", vendor:"CompTIA", track:"red", level:"Intermediate", hours:"~120h", color:"#dc2626",
 desc:"Pentesting end-to-end: planning, recon, exploitation, reporting. Más amplio que OSCP, menos profundo.", status:"coming"},
{id:"oscp", name:"OSCP", code:"OSCP", vendor:"OffSec", track:"red", level:"Advanced", hours:"~300h+", color:"#f97316",
 desc:"Offensive Security Certified Professional. La cert ofensiva más respetada. Examen 24h hackeando lab. 'Try Harder'.", status:"coming"},
{id:"ejpt", name:"eJPT", code:"eJPTv2", vendor:"INE/eLearnSecurity", track:"red", level:"Entry", hours:"~80h", color:"#fb923c",
 desc:"eLearnSecurity Junior Penetration Tester. Buena entrada práctica al pentesting antes de OSCP.", status:"coming"},
{id:"ceh", name:"CEH", code:"CEH v13", vendor:"EC-Council", track:"red", level:"Intermediate", hours:"~100h", color:"#ea580c",
 desc:"Certified Ethical Hacker. Muy demandada por HR aunque criticada técnicamente. Reconocida por DoD.", status:"coming"},
{id:"osep", name:"OSEP", code:"OSEP", vendor:"OffSec", track:"red", level:"Advanced", hours:"~250h+", color:"#c2410c",
 desc:"Offensive Security Experienced Penetration Tester. Bypass AV/EDR, AD attacks. Continuación de OSCP.", status:"coming"},
{id:"oswe", name:"OSWE", code:"OSWE", vendor:"OffSec", track:"red", level:"Advanced", hours:"~250h+", color:"#9a3412",
 desc:"Offensive Security Web Expert. Especialización en web app pentesting con análisis de código fuente.", status:"coming"},
{id:"crto", name:"CRTO", code:"CRTO", vendor:"Zero-Point Security", track:"red", level:"Advanced", hours:"~150h", color:"#7c2d12",
 desc:"Certified Red Team Operator. Cobalt Strike, evasion, AD attacks. Muy práctica.", status:"coming"},

// === CLOUD SECURITY ===
{id:"awssec", name:"AWS Security – Specialty", code:"SCS-C02", vendor:"AWS", track:"cloud", level:"Advanced", hours:"~150h", color:"#ff9900",
 desc:"Especialización en seguridad AWS: IAM, KMS, GuardDuty, encryption, incident response en cloud.", status:"coming"},
{id:"az500", name:"Azure Security Engineer", code:"AZ-500", vendor:"Microsoft", track:"cloud", level:"Intermediate", hours:"~120h", color:"#0078d4",
 desc:"Azure Security Engineer Associate. Identity, network, compute, data security en Azure.", status:"coming"},
{id:"gcpsec", name:"GCP Security Engineer", code:"PCSE", vendor:"Google Cloud", track:"cloud", level:"Intermediate", hours:"~120h", color:"#4285f4",
 desc:"Professional Cloud Security Engineer. Identity, data, infra security en GCP.", status:"coming"},
{id:"ccsp", name:"CCSP", code:"CCSP", vendor:"ISC2", track:"cloud", level:"Advanced", hours:"~150h", color:"#06b6d4",
 desc:"Certified Cloud Security Professional. Vendor-neutral. 5 años exp recomendados. Premium para arquitectos cloud.", status:"coming"},

// === GRC / MANAGEMENT ===
{id:"cissp", name:"CISSP", code:"CISSP", vendor:"ISC2", track:"grc", level:"Expert", hours:"~250h+", color:"#1e40af",
 desc:"Gold standard de gestión. 8 dominios. 5 años exp. Para CISO/arquitectos/managers. Muy valorada.", status:"coming"},
{id:"cism", name:"CISM", code:"CISM", vendor:"ISACA", track:"grc", level:"Expert", hours:"~200h", color:"#1e3a8a",
 desc:"Certified Information Security Manager. Foco en gestión y gobernanza. Alternativa a CISSP más managerial.", status:"coming"},
{id:"cisa", name:"CISA", code:"CISA", vendor:"ISACA", track:"grc", level:"Advanced", hours:"~200h", color:"#1e293b",
 desc:"Certified Information Systems Auditor. Para auditores IT. Muy demandada en Big4 y banca.", status:"coming"},
{id:"crisc", name:"CRISC", code:"CRISC", vendor:"ISACA", track:"grc", level:"Advanced", hours:"~150h", color:"#0f172a",
 desc:"Certified in Risk and Information Systems Control. Gestión de riesgo IT.", status:"coming"},
{id:"iso27001li", name:"ISO 27001 Lead Implementer", code:"ISO27001-LI", vendor:"PECB/BSI", track:"grc", level:"Intermediate", hours:"~80h", color:"#475569",
 desc:"Implementador líder de SGSI según ISO 27001. Necesario en consultoras de cumplimiento.", status:"coming"},
{id:"iso27001la", name:"ISO 27001 Lead Auditor", code:"ISO27001-LA", vendor:"PECB/BSI", track:"grc", level:"Intermediate", hours:"~80h", color:"#334155",
 desc:"Auditor líder de SGSI. Para auditores externos certificadores.", status:"coming"},

// === NETWORK SECURITY ===
{id:"ccnasec", name:"CCNA", code:"200-301", vendor:"Cisco", track:"network", level:"Foundational", hours:"~150h", color:"#1ba0d7",
 desc:"Cisco Certified Network Associate. Networking fundamental Cisco. Base para certs Cisco superiores.", status:"coming"},
{id:"ccnp", name:"CCNP Security", code:"350-701", vendor:"Cisco", track:"network", level:"Advanced", hours:"~250h", color:"#0c80b8",
 desc:"Cisco Certified Network Professional Security. Avanzada en seguridad de red Cisco.", status:"coming"},
{id:"jncissec", name:"JNCIS-SEC", code:"JN0-335", vendor:"Juniper", track:"network", level:"Intermediate", hours:"~120h", color:"#84b818",
 desc:"Juniper Networks Certified Specialist Security. Seguridad en plataformas Juniper.", status:"coming"}
];
